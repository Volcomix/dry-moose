...
class Market extends Bot {
  ...
  async discover() {
    ...
    if (this.isCancelled) {
      ...
      this.emit(Events.Status, Status.Discovered, instruments)
    ...
    return this.page.evaluate(
      instruments =>
        instruments.map(instrument => ({
          ...
          minPositionAmount: instrument.MinPositionAmount,
          minPositionAmountAbsolute: instrument.MinPositionAmountAbsolute,
          minAmount: Math.max(
            instrument.MinPositionAmount / Math.max(...instrument.Leverages),
            instrument.MinPositionAmountAbsolute,
          ),
          leverages: instrument.Leverages,
