...
var BBWChart = (function (_super) {
    ...
    BBWChart.prototype.render = function () {
        ScaleUtils.updateYScale(this.props.monitoringData.bband, this.xBBandAccessor, this.yBandWidthAccessor, this.props.xScale, this.yScale, this.props.height, BBWChart.yDomainPadding);
