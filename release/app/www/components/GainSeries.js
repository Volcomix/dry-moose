...
var GainSeries = (function (_super) {
    ...
    function GainSeries() {
        ...
        this.getGains = function (gain) {
            var direction, option = gain.option, x1 = _this.props.xScale(option.quote.dateTime), x2 = _this.props.xScale(option.expiration), y = _this.props.yScale(option.quote.close);
            return (React.createElement("g", {"key": +gain.dateTime, "transform": 'translate(' + x1 + ', ' + y + ')'}, React.createElement("text", {"className": 'material-icons'}, _this.getDirectionIcon(option)), React.createElement("circle", {r: 4.5}), React.createElement("line", {"x2": x2 - x1})));
        };
    }
