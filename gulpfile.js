...
gulp.task('run:db', ['db:clean'], function() {
	var Supervisor = require('./release/Supervisor'),
		...
		processor = new VolcoProcessor(
            90, 0, 20,
            {
                ...
                minBeforeCross: 14, minAfterCross: 1, maxAfterCross: 5,
	...
	return new Supervisor(collector, processor, investor, celebrator, capacitor).run();
});